# Environment Validator (Environment Checker)
...
* [Known Issue: Pre-Update Health Check fails with AllResults property error](AllResults-property-error-during-Pre-Update-Health-Check.md)
## Networking
